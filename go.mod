...
module schildwaechter/schildcafe.servitor
...
require (
	...
	github.com/gohugoio/hugo v0.143.0 // indirect
...
replace github.com/atarantini/ginrequestid => github.com/atarantini/ginrequestid v0.0.0-20210724203832-ce1514b9d50b
